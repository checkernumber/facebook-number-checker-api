# Facebook Number Checker API — official examples | CheckNumber

This repository documents the CheckNumber Facebook Number Checker API integration contract using facts from the expansion manifest.

- Product page: https://checknumber.ai/products/facebook
...
```bash
curl -X POST "https://api.checknumber.ai/v1/tasks" -H "X-API-Key: ${CHECKNUMBER_API_KEY}" -F "file=@examples/numbers.txt" -F "task_type=facebook"
...
| --- | --- | --- | --- | --- | --- |
| `facebook` | Number Checker | phone | 100–10000000 rows | `number, activated` | [docs](https://docs.checknumber.ai/facebook-bulk-number-checker) |
| `facebook_email` | Email Checker | email | 1000–10000000 rows | `email, activated` | [docs](https://docs.checknumber.ai/facebook-email-checker) |
...
- `facebook`: https://docs.checknumber.ai/facebook-bulk-number-checker
- `facebook_email`: https://docs.checknumber.ai/facebook-email-checker
