// Facebook Number Checker API — browser/JavaScript example.
// Workflow: submit a file of E.164 numbers -> poll status -> download results.
// Docs: https://docs.checknumber.ai/facebook-bulk-number-checker
//
...
const TASK_TYPE = "facebook"; // facebook | facebook_email
...
async function checkFacebook(file) {
...
//   const url = await checkFacebook(e.target.files[0]);
